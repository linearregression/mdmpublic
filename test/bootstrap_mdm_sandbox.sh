...
## --
## Created : <2015-05-28>
## Updated: Time-stamp: <2016-07-26 07:24:18>
##-------------------------------------------------------------------
function log() {
    local msg=${1?}
...
if [ $container_status = "none" ]; then
    docker run -d -t --privileged -v /root/couchbase/:/opt/couchbase/ -h $container_hostname --name $container_name -p 8080-8180:8080-8180 -p 8443:8443 -p 9200:9200 -p 9500:9500 -p 80:80 -p 443:443 -p 6022:22 $image_name /usr/sbin/sshd -D
elif [ $container_status = "dead" ]; then 
    docker start $container_name    
fi
