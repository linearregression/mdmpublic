...
##  Boot docker container: docker run -d -p 61080:80 -p 443:443 -p 61022:22 -h chefserver --name denny-chefserver --privileged denny/chefserver:latest /usr/sbin/sshd -D
##  Start container:
...
##    create knife.rb, say ~/.chef/denny-chef-knife.rb
##    knife cookbook list -c ~/.chef/denny-chef-knife.rb 
##################################################
