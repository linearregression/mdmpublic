...
##  Boot docker container: docker run -t -d -h jenkins --name denny-jenkins --privileged -p 61022:9000 -p 61023:22 -p 61081:28000 -p 61082:28080 denny/jenkins:latest /usr/sbin/sshd -D
##
##     ruby --version
##     gem --version
##     which docker
