...
##  Download docker image: docker pull denny/nagios:v1
##
##  Start container:
##   docker stop  denny-nagios
##   docker rm  denny-nagios
##
##   docker run -t -d --privileged --name denny-nagios -h nagios -p 61423:22 -p 61481:80 denny/nagios:v1 /usr/sbin/sshd -D
##
